...
const ProjectCard = ({ title, description, technologies, achievements, date, index }: ProjectCardProps) => {
  ...
  return (
    ...
    >
      ...
      <AnimatePresence>
        {isHovered && (
          <div className="absolute inset-0 bg-gradient-to-b from-black/95 to-purple-900/95 backdrop-blur-sm">
            <motion.div
              ...
              <div className="p-6 flex flex-col h-full">
                  ...
                  <div className="mb-6">
                    ...
                    <ul className="space-y-2.5">
                      {achievements.map((achievement, i) => (
                        <div key={i} className="flex items-start gap-2 bg-purple-500/5 p-2.5 rounded-lg hover:bg-purple-500/10 transition-colors text-sm text-gray-400">
                          <motion.li
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {technologies.map((tech, i) => (
                        <div key={tech} className="px-2.5 py-1 bg-purple-500/10 rounded-full text-xs text-purple-300 hover:bg-purple-500/20 transition-colors">
                          <motion.span
                ...
                <div className="mt-4 w-full">
                  <motion.div
                    ...
                    whileTap={{ scale: 0.98 }}
                  >
                    <button className="w-full px-4 py-2.5 bg-gradient-to-r from-purple-500/20 to-pink-500/20 hover:from-purple-500/30 hover:to-pink-500/30 text-purple-300 rounded-lg text-sm transition-all flex items-center justify-center gap-2 group">
